#nullable enable
    ...
    namespace UniOption {
        ...
        public readonly struct ValueOption<T> : IOption, IEquatable<ValueOption<T>> where T : struct {
            ...
            /// </summary>
            public static readonly ValueOption<T> None = new();
            ...
            public ValueOption<(T, T2)> Zip<T2>(Option<T2> other) where T2 : class =>
                IsSome && other.IsSome ? ValueOption<(T, T2)>.Some((_content!.Value, other.Reduce(default(T2)!)!)) : ValueOption<(T, T2)>.None;
            ...
            public ValueOption<T> Do<TContext>(Action<T, TContext> ifSome, TContext context) {
                if (_content.HasValue) ifSome(_content.Value, context);
                return this;
            }
            ...
            public ValueOption<T> Do<TContext>(ActionRef<T, TContext> ifSome, ref TContext context) {
                if (_content.HasValue) ifSome(_content.Value, ref context);
                return this;
            }
            ...
            public override bool   Equals(object? other) => other is T otherValue && Equals(otherValue);
